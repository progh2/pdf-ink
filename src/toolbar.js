...
/**
 * #399→#435: 아홉 칸은 그대로. 도장은 기본 스티커가 됐고(#401) 그 자리를
 * 손바닥이 받았다. #56의 옛 잠금(선택 다음 스탬프)은 마스터가 손바닥을
 * 요청하기 전 명세다 — #427이 그 옛 글자를 따라 손바닥을 지웠다가
 * 2026-09-15 마스터의 제보로 되돌렸다. 다시 빼지 말 것.
 */
